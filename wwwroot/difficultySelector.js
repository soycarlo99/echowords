document.addEventListener('DOMContentLoaded', () => {
    ...
    const correctBonusText = document.getElementById('correctBonus');
    const rewriteBonusText = document.getElementById('rewriteBonus');
    ...
    function updateDifficultyDisplay(difficulty) {
        ...
        correctBonusText.textContent = `Time Bonus (correct word): +${settings.correctWordBonus} seconds`;
        rewriteBonusText.textContent = `Time Bonus (rewrite word): +${settings.rewriteWordBonus} seconds`;
