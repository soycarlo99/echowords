...
public class Actions
{
    ...
    public Actions(WebApplication app, IHubContext<GameHub> hubContext, NpgsqlDataSource dataSource)
    {
        ...
        app.MapPost(
            ...
            async (HttpContext context) =>
            {
                ...
                bool success = await PlayerName(
                    newPlayer,
                    context.Request.Cookies["ClientId"],
                    lobbyId
                );
                return success
                    ? Results.Ok("New player added successfully.")
        ...
        app.MapPost(
            ...
            async (HttpContext context) =>
            {
                ...
                try
                {
                    ...
                    {
                        await _hubContext
                            .Clients.Group(lobbyId)
                            .SendAsync("PlayerJoined", updatedPlayer);
                    ...
                    else
                    {
                        ...
                        if (await insertReader.ReadAsync())
                        {
                            newPlayer = new Player
                            {
                                ...
                                ClientId = insertReader.IsDBNull(2)
                                    ? null
                                    : insertReader.GetString(2),
                                LobbyId = insertReader.GetString(3),
                                AvatarSeed = insertReader.IsDBNull(4)
                                    ? null
        ...
        app.MapPost(
            ...
            async (string lobbyId, HttpContext context) =>
            {
                try
                {
